...
const MOCK_REGISTRATIONS = [
  ...
  {
    id: "FC-2026-0003",
    farmerName: "Pedro Penduko",
    contact: "09095551212",
    province: "Nueva Ecija",
    municipality: "Bongabon",
    barangay: "Vega",
    vegetableId: "rice", // Let's populate some rice
    areaSqm: 40000,
    areaHa: 4.0,
  ...
  {
    id: "FC-2026-0008",
    farmerName: "Marcelo del Pilar",
    contact: "09276665544",
    province: "Pangasinan",
    municipality: "San Manuel",
    barangay: "San Roque",
    vegetableId: "rice", // Pangasinan is also massive for Rice!
    areaSqm: 25000,
    areaHa: 2.5,
    expectedYieldTons: 11.25,
  ...
  },
  {
    ...
    municipality: "Atok",
    barangay: "Paoay",
    vegetableId: "broccoli", // Highland specialist Broccoli
    areaSqm: 18000,
    areaHa: 1.8,
    expectedYieldTons: 26.1,
  ...
  },
  {
    ...
    barangay: "Kinuskusan",
    vegetableId: "ampalaya",
    areaSqm: 4000,
    areaHa: 0.4,
    expectedYieldTons: 4.8,
    plantingDate: "2026-06-06",
    harvestDate: "2026-08-15",
    timestamp: "2026-05-29T10:45:00Z"
  },
  {
    id: "FC-2026-0013",
    farmerName: "Francisco Balagtas",
    contact: "09214567890",
    province: "Nueva Ecija",
    municipality: "Cabanatuan City",
    barangay: "San Josef Sur",
    vegetableId: "bellpepper", // Highland vegetable growing in lowlands too!
    areaSqm: 7500,
    areaHa: 0.75,
    expectedYieldTons: 9.38,
    plantingDate: "2026-06-14",
    harvestDate: "2026-09-07",
    timestamp: "2026-05-29T12:00:00Z"
  },
  {
    id: "FC-2026-0014",
    farmerName: "Teresa Magbanua",
    contact: "09273456789",
    province: "Davao del Sur",
    municipality: "Santa Cruz",
    barangay: "Melilia",
    vegetableId: "lettuce", // Fresh lettuce
    areaSqm: 9000,
    areaHa: 0.9,
  ...
  {
    id: "FC-2026-0015",
    farmerName: "Macario Sakay",
    contact: "09159876543",
    province: "Benguet",
    municipality: "La Trinidad",
    barangay: "Wangal",
    vegetableId: "cauliflower", // Highland cauliflower
    areaSqm: 22000,
    areaHa: 2.2,
    expectedYieldTons: 33.0,
